...
def mean_pms(
    ...
    if len(tp_idx[0]) == 0:
        return print("There are no True Positive Predictions in this dataset. No predictor maps are plotted.")
    if len(fn_idx[0]) == 0: 
        return print("There are no False Negative Predictions in this dataset. No predictor maps are plotted.")
